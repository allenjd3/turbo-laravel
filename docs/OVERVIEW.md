...
In order for replace, update and remove actions to work as expected, make sure you include the dom id in your partial so Turbo Stream knows what to target like in the following example: 
